            ...
            <?php foreach ($buku as $item) : ?>
                ...
                <div class="card" style="width: 15rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Sinopsis: <?= substr($item["sinopsis"], 0, strlen($item["sinopsis"]) * 0.1); ?><a href="detailBuku.php?id=<?= $item["id"]; ?>" style="color: pink;"> Baca Selengkapnya</a></li>
                    </ul>
