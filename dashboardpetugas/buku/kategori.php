...
<h1 class="mt-4" style="text-shadow: 0 0 5px red; color:white">KATEGORI BUKU</h1>
<div class="row">
  <div class="col-md-12">    
...
<div class="row justify-content-end mt-3">
  <div class="col-md-6 text-md-end">
    <a href="tambahBuku.php" class="btn btn-primary btn-cyann">Kembali</a> <!-- Tombol kembali dipindahkan ke sini -->
  </div>
</div>
</body>
</html>
