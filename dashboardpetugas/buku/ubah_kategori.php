...
<h1 class="mt-4" style="text-shadow: 0 0 5px red; color:white">UPDATE KATEGORI</h1>
<div class="card">
    <div class="card body">
        <div class="row">
            <form method="post">
                <div class="col-md-12">
                    <div class="row mb-3">
                        <div class="col-md-2" style="text-shadow: 0 0 5px cyan; color:black">Nama Kategori</div>
